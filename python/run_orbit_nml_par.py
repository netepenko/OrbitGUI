...
# try:
#     os.symlink(output_dir, './orb', target_is_directory=True)
#     print("created symling to %s from original OS" %output_dir)
# except:
os.symlink = symlink
try:
...
try:
    # copy the important data file to the standard  output directory    
