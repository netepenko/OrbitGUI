      ...
      real*8 rdist(n_par),ZDist(n_par), phdangle(n_par), rc(n_par), rcd(n_par)

      real*8, dimension(n_par) :: ports, portsph, al0s, be0s, rds, zds, phda, rcol, rcdet
...
c     current position, velocity and magnetic field       
     ...
     > efflim, tol, detec, detector_number, channel_number, detector_id
      ...
      common/detcom/d,xc,yc,al0,be0,al0s,be0s, rd, rds,phd,phda, rcol, rcdet, xd,yd,zd,zds,nseg,nx,ny
