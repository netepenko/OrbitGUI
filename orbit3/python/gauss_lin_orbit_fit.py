# fit random gaussians to orbit data
#
# use linear fit, parameters can be negative
#
...
# add set 2
view_dir = './nml_orb_p6_lower_position/'
view_files += [ \
    view_dir+'track_1011.data', \
    view_dir+'track_2011.data', \
    view_dir+'track_3011.data', \
